...
2.  <a name="li17137133433914"></a>工程中引入API网关签名SDK。
    ...
    3.  将解压出来的jar文件引用到依赖路径中。如[图1](#fig198751160312)所示：

        **图 1**  将jar文件引用到依赖路径中<a name="fig198751160312"></a>  
        ![](figures/将jar文件引用到依赖路径中.png "将jar文件引用到依赖路径中")
...
3.  对请求进行签名。
    ...
    4.  发送带有签名信息的请求。
        ...
        下载成功后，解压示例代码包“SdkDemo.zip”，在“SdkDemo\\src\\main\\java\\com\\cloud\\apigateway\\sdk\\demo”路径下获取以下三个文件：

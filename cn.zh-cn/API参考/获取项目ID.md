# 获取项目ID<a name="css_03_0071"></a>

## 从控制台获取项目ID<a name="section634410269180"></a>
...
获取项目ID的接口为“GET https://\{Endpoint\}/v3/projects/”，其中\{Endpoint\}为IAM的终端节点，可以从[地区和终端节点](https://developer.huaweicloud.com/endpoint?IAM)点获取。接口的认证鉴权请参见[3.2 认证鉴权](认证鉴权.md)。
